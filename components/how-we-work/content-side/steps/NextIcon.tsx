export const NextIcon = ({ done, direction }: { done?: boolean; direction: 'left' | 'right' }) => {
  return (
    <svg
      viewBox="0 0 28 28"
      className={`arrow-svg ${direction === 'left' ? 'left' : 'right'} ${done ? 'done' : ''}`}
    >
      {direction === 'right' && (
        <>
          ...
          <line className={`arrow-icon line3-right`} x1="16.2" y1="4.6" x2="26.2" y2="13.5" />
